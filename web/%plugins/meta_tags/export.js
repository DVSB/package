    ...
    module.exports.init = function(self) {

        var metaTags = [];
        var allMarkdowns = self.all_files.markdowns;

        allMarkdowns.forEach(function(markdownObj){

            var path = markdownObj._fullpath + markdownObj._filename;
