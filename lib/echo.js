    ...
    var _error0002 = function(where, what){

        var message = "error: in file ".red.bold + where.red.bold;
        message += " is wrong layout ".red.bold + what.red.bold;
